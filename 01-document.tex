...
\par\noindent\begin{supertabular}{@{}p{\lensymb}@{}p{\lenwhat}@{\hspace{\lencsep}}p{\lendefn}}
    ...
    $\alpha$        & Crank angular position from TDC, \rad,                        & Eq.~(\ref{eq:x})                  \\
    $\gamma$        & Specific heat ratio, ---,                                     & Eq.~(\ref{eq:def.gamma})          \\[6pt]
    \multicolumn{3}{@{}l}{\em Subscripts:} \\
    ${}_d$                  & \multicolumn{2}{@{}p{\lenWHAT}}{displaced}                                                \\
    ${}_i$                  & \multicolumn{2}{@{}p{\lenWHAT}}{process index}                                            \\
    ${}_{\mathrm{BDC}}$     & \multicolumn{2}{@{}p{\lenWHAT}}{Bottom Dead Center}                                       \\
    ${}_{\mathrm{TDC}}$     & \multicolumn{2}{@{}p{\lenWHAT}}{Top Dead Center}                                          \\
    ${}_P$                  & \multicolumn{2}{@{}p{\lenWHAT}}{taken at constant pressure}                               \\
    ${}_{RL}$               & \multicolumn{2}{@{}p{\lenWHAT}}{that of $R/L$}                                            \\
    ${}_{SD}$               & \multicolumn{2}{@{}p{\lenWHAT}}{that of $S/D$}                                            \\
    ${}_u$                  & \multicolumn{2}{@{}p{\lenWHAT}}{unit or unitary}                                          \\
    ${}_v$                  & \multicolumn{2}{@{}p{\lenWHAT}}{taken at constant specific volume}                        \\[6pt]
