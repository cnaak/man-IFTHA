...
\section{Introduction}
    ...
    A further look into polytropic processes~\cite{2012-ChristiansJ-IntJMechEngEduc} reveals that the polytropic exponent can be 

    if the heat-to-work transfer
    ratio, also referred to as energy transfer ratio

    The development of reference~\cite{2020-NaaktgeborenC-Polytropic-engrXiv-rev02}
